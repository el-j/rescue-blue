export const translations = {
  de: {
    ...
    navShare: 'Petition teilen',
    shareTitle: 'Petition teilen',
    shareSubtitle: 'Scanne den QR-Code oder kopiere den Link',
    shareDownloadQr: 'QR-Code herunterladen',
    ...
    demoSourceLabel: 'Datengrundlage',
    demoSourceLive: 'Live aus Sonntagsfrage-API',
    demoSourceFallback: 'Lokaler Fallback-Wert',
    demoSourceApi: 'Quelle: DAWUM Sonntagsfrage (Bundestag)',
    demoSourceInstitute: 'Institut',
    demoSourceDate: 'Erhebung',
    demoSourceFieldwork: 'Feldzeit',
    demoSourceSample: 'Stichprobe',
    demoSourceMethod: 'Methode',
    demoSourceStand: 'Stand',
    demoSourceButton: 'Quelle & Methode öffnen',
    demoSourceWhyInstituteLabel: 'Warum INSA?',
    demoSourceWhyInstituteTooltip: 'Die Grafik nutzt bewusst nur ein festes Institut (INSA), damit die Zeitreihe methodisch konsistent bleibt und keine Sprünge durch Institutwechsel entstehen.',
  ...
  en: {
    ...
    navSign: 'Sign Now',
    navShare: 'Share petition',
    shareTitle: 'Share petition',
    shareSubtitle: 'Scan the QR code or copy the link',
    shareDownloadQr: 'Download QR code',
    ...
    demoSourceLabel: 'Data basis',
    demoSourceLive: 'Live from polling API',
    demoSourceFallback: 'Local fallback value',
    demoSourceApi: 'Source: DAWUM Sunday poll (Bundestag)',
    demoSourceInstitute: 'Institute',
    demoSourceDate: 'Survey date',
    demoSourceFieldwork: 'Fieldwork',
    demoSourceSample: 'Sample',
    demoSourceMethod: 'Method',
    demoSourceStand: 'Updated',
    demoSourceButton: 'Open source & method',
    demoSourceWhyInstituteLabel: 'Why INSA?',
    demoSourceWhyInstituteTooltip: 'This chart intentionally uses one fixed institute (INSA) to keep the time series methodologically consistent and avoid jumps caused by switching institutes.',
...
export type ContentTab = keyof typeof blueSayings.de
export type LetterTarget = keyof typeof openLetters.de
...
export type Translation = Widen<typeof translations.de>
export type Sayings = Widen<typeof blueSayings.de>
export type Letters = Widen<typeof openLetters.de>
export type Facts = Widen<typeof FACTS.de>
export type Faqs = Widen<typeof FAQS.de>
export type ScienceContent = Widen<typeof SCIENCE_CONTENT.de>
...
export function getLocaleCode(lang: Locale) {
